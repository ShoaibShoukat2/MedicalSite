...
MIDDLEWARE = [
    ...
    'chat.middleware.ChatAuthMiddleware',  # Chat authentication middleware
]

CSRF_TRUSTED_ORIGINS = [
    'http://127.0.0.1:8000',
    'http://localhost:8000',
    'https://michdmp.pythonanywhere.com',
    'http://69.62.108.86',
    'https://reeducavie.com',
    'http://reeducavie.com',
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'patientdashboard.context_processors.patient_notifications',  # Patient notifications
            ],
        },
    },
]
